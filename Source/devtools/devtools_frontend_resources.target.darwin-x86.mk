...
$(gyp_shared_intermediate_dir)/resources/inspector/Images/chromeLeft.png: $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/Images/chromeLeft.png $(GYP_TARGET_DEPENDENCIES) | $(ACP)
	@echo Copying: $@
	$(hide) mkdir -p $(dir $@)
	$(hide) $(ACP) -rpf $< $@

$(gyp_shared_intermediate_dir)/resources/inspector/Images/chromeMiddle.png: $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/Images/chromeMiddle.png $(GYP_TARGET_DEPENDENCIES) | $(ACP)
	@echo Copying: $@
	$(hide) mkdir -p $(dir $@)
	$(hide) $(ACP) -rpf $< $@

$(gyp_shared_intermediate_dir)/resources/inspector/Images/chromeRight.png: $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/Images/chromeRight.png $(GYP_TARGET_DEPENDENCIES) | $(ACP)
	@echo Copying: $@
	$(hide) mkdir -p $(dir $@)
	$(hide) $(ACP) -rpf $< $@
